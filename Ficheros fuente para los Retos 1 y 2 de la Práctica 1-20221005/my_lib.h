...
struct my_stack_node {      // node de la pila (elemento)
    void *data;
...
struct my_stack {   // pila
    ...
    struct my_stack_node *top;  // apunta al node de la parte superior
};  
...
struct my_stack *my_stack_init(int size){
    ...
    s = (void *) malloc(sizeof(struct my_stack));
